//https://faksestoreapi.com/products

let grid = document.querySelector(".products");
let filterInput = document.getElementById("filterInput");

// getting the data from fakestoreapi.com website by using fetch, then promises
...
// add event listener to iterate over the products and match by filter
...
// get value from the API and create dynamic element
  ...
  div.innerHTML = `
    <img src="${image}" class="bg-cover img" alt="img1">
      <div class="text-center py-3 font-poppins">
        ...
        <button class="border-2 px-8 py-1 bg-yellow-400 border rounder-md">Buy Now</button>
      </div>
  `
